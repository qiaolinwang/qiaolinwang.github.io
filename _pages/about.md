...
I am Qiaolin Wang, a second-year Master's student in Electrical Engineering at Columbia University, advised by <a href="https://nima.ee.columbia.edu/" target="_blank">Professor Nima Mesgarani</a> in the <a href="https://naplab.ee.columbia.edu/" target="_blank">Neural Acoustic Processing Lab</a>.

I am passionate about building models that can <strong>listen, understand, and speak</strong> as naturally as humans do. My current research investigates the fundamental capabilities of <strong>Large Audio Language Models (LALMs)</strong>, from their <a href="{{ '/publications/' | relative_url }}#layer-wise-minimal-pair-probing-reveals-contextual-grammatical-conceptual-hierarchy-in-speech-representations">internal representations about syntax and context</a>, to their capacity for <a href="{{ '/publications/' | relative_url }}#sightsound-r1-cross-modal-reasoning-distillation-from-vision-to-audio-language-models">complex reasoning across modalities</a>. My future work aims to advance this by pioneering deeper <strong>audio-visual perception alignment</strong> and unified models for <strong>multimodal reasoning and generation</strong>.
